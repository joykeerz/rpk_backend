...
<head>
    <script src="{{ asset('template/assets/js/color-modes.js') }}"></script>
    ...
    <title>{{ config('app.name', 'RPK Bulog Backend') }}</title>
    ...
    <!-- Custom styles for this template -->
    <link href="{{ asset('template/dashboard/dashboard.css') }}" rel="stylesheet">
    {{-- Scripts --}}
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">{{ config('app.name', 'RPK Bulog Backend') }} </a>
    ...
    <script src="{{ asset('Template/dashboard/dashboard.js') }}"></script>
</body>
