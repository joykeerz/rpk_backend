        ...
        <div class="formContainer ">
            <div class="inputLabelContainer grid grid-cols-2 gap-0.5">
                ...
                <div class="tb_no_telp_branch flex flex-col">
                    ...
                    <input type="text" name="tb_no_telp_branch" id="tb_no_telp_branch" value="{{ $branch->no_telp_branch }}">
                </div>
                <div class="tb_alamat_branch flex flex-col">
                    <label for="tb_alamat_branch">Alamat</label>
                    <input type="text" name="tb_alamat_branch" id="tb_alamat_branch" value="{{ $branch->alamat_branch }}">
                </div>
            </div>
        </div>
