    ...
    <div class="formContainer m-3 border rounded p-3">
        <form action="{{ route('location.update', ['id' => $location->id]) }}" method="POST">
            ...
            <div class="inputLabelContainer grid grid-cols-2 gap-0.5">
                <input type="hidden" name="tb_gudang_id" id="tb_gudang_id" value="{{ $location->gudang_id }}">
                <div class="tb_nama_location flex flex-col">
                    <label for="tb_nama_location">Nama Location*</label>
                    <input value="{{ $location->location_name }}" type="text" name="tb_nama_location" id="tb_nama_location">
                ...
                <div class="tb_parent_location flex flex-col">
                    ...
                    <input value="{{ $location->parent_location }}" type="text" name="tb_parent_location"
                ...
                <div class="tb_external_id flex flex-col">
                    ...
                    <input value="{{ $location->external_location_id }}" type="text" name="tb_external_id"
                        id="tb_external_id">
