    ...
    <form action="{{ route('company.update', ['id' => $company->cid]) }}" method="post">
        ...
        <div class="formContainer grid grid-cols-2 gap-0.5">
            <div class="namaCompany">
                ...
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_nama_company" id="tb_nama_company" placeholder="" value="{{ $company->nama_company }}">
            </div>

            <div class="penanggungJawab">
                <div class="penanggungJawab">
                    <label for="tb_user_id" class="block text-sm font-medium text-gray-700">Penanggung Jawab</label>
                    <select name="tb_user_id" id="tb_user_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border p-1">
            ...
            <div class="kodeCompany">
                ...
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_kode_company" id="tb_kode_company" placeholder="" value="{{ $company->kode_company }}">
            </div>

            <div class="partnerCompany">
                <label for="" class="block text-sm font-medium text-gray-700">Partner Company</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_partner_company" id="tb_partner_company" placeholder="" value="{{ $company->partner_company }}">
            </div>

            <div class="taglineCompany">
                <label for="" class="block text-sm font-medium text-gray-700">Tagline Company</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50 border p-1ne_company" id="tb_tagline_company" name="tb_tagline_company" placeholder="" value="{{ $company->tagline_company }}">
            </div>

            <div class="jalan">
                <label for="" class="block text-sm font-medium text-gray-700">Jalan</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50  border p-1" name="tb_jalan" id="tb_jalan" placeholder="" value="{{ $company->jalan }}">
            </div>

            <div class="jalan_ext">
                <label for="" class="block text-sm font-medium text-gray-700">Jalan 2</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring
                    focus:ring-indigo-200 focus:ring-opacity-50  border p-1" name="tb_jalan_ext" id="tb_jalan_ext" placeholder="" value="{{ $company->jalan_ext }}">

            </div>

            <div class="blok">
                <label for="" class="block text-sm font-medium text-gray-700">Blok</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_blok" id="tb_blok" placeholder="" value="{{ $company->blok }}">
            </div>

            <div class="rt">
                <label for="" class="block text-sm font-medium text-gray-700">RT</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_rt" id="tb_rt" placeholder="" value="{{ $company->rt }}">
            </div>

            <div class="rw">
                <label for="" class="block text-sm font-medium text-gray-700">RW</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_rw" id="tb_rw" placeholder="" value="{{ $company->rw }}">
            </div>

            <div class="provinsi">
                <label for="" class="block text-sm font-medium text-gray-700">Provinsi</label>
                <select onchange="loadKota(event);" name="tb_prov" id="tb_prov" class="border rounded-md py-2 px-3 w-full">
            ...
            <div class="kota">
                ...
                <select onchange="loadKecamatan(event);" name="tb_kota" id="tb_kota" class="border rounded-md py-2 px-3 w-full">
            ...
            <div class="kecamatan">
                ...
                <select onchange="loadKelurahan(event);" name="tb_kecamatan" id="tb_kecamatan" class="border rounded-md py-2 px-3 w-full">
            ...
            <div class="kodepos">
                ...
                <input type="text" class="mt-1 block w-full rounded-md shadow-sm focus:border-indigo-300
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border border-gray-300 p-1" name="tb_kodepos" id="tb_kodepos" placeholder="" value="{{ $company->kode_pos }}">
            </div>

            <div class="external_id">
                <label for="" class="block text-sm font-medium text-gray-700">ID External</label>
                <input type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50 border p-1" name="tb_external_id" id="tb_external_id" placeholder="" value="{{ $company->external_company_id }}">
            </div>
        </div>
